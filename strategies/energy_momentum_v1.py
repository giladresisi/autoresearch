...
Extracted from: autoresearch/mar20  |  Commit: e9886df
Optimization: 30 iterations, keep/discard by train_total_pnl
Sector: Energy / Materials
Training window: 2025-12-20 → 2026-03-06
Test window:     2026-03-06 → 2026-03-20

This module is self-contained: all indicator functions are duplicated here
so the strategy can be imported and executed without coupling to any other
module. This is intentional — verbatim extraction from train.py preserves
exact numeric behavior as optimized.
"""
import numpy as np
import pandas as pd
