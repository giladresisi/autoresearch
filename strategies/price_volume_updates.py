"""
strategies/price_volume_updates.py — Extracted from autoresearch/price-volume-updates @ de8fa2b
"""

METADATA = {
    "name":         'price-volume-updates',
    "sector":       'unknown',
    ...
    "test_end":     '2026-03-20',
    "source_branch": 'autoresearch/price-volume-updates',
    "source_commit": 'de8fa2b',
    "train_pnl":    84.8,
    "train_sharpe": 0.127549,
    "train_trades": 385,
    "description":  '',
}
...
def screen_day(df: pd.DataFrame, today) -> "dict | None":
    ...
    if price_1030am <= sma50 or price_1030am <= sma100 or sma20 <= sma50 * 1.01 or sma50 <= sma100 * 1.005:
        return None
